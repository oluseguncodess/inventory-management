    ...
    <section className="w-full p-4 md:p-12 flex flex-col md:flex-row md:justify-between gap-10 md:mt-8">
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col md:flex-row mt-4">
          <Link href="/auth/sign-up" className="group relative px-8 py-4 bg-linear-to-r from-cyan-500 to-blue-500 rounded-xl font-semibold text-white md:text-md shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all duration-300 hover:scale-105 text-center">
            Get Started
